...
enum SM1_States {SM1_Start, SM1_init, SM1_waitAction, SM1_poundPressed, SM1_unlockWait, SM1_UnlockDoor, SM1_LockDoor, SM1_doorBuffer } SM1_State;
...
int main(void) {
	...
	unsigned char A7 = PINA & 0x80;
   	unsigned char tmpB; // hold temp for PORTB for if checks
